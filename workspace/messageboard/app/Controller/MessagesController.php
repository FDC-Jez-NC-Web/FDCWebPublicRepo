 ...
 */
    ...
    public function message_details() {
       ...
       $senderReceiverInfo = $this->Message->find('first', array(
        'fields' => array(
        ...
        'conditions' => array(
            'Message.message_owner_id' => $sender_id ? $sender_id : $sender_owner_id,
            'Message.message_receiver_id' => $receiver_id
        )
        ));


        $this->set('message_sender_and_receiver', $senderReceiverInfo);
    ...
    public function replyMessage() {
        ...
        if ($this->request->is('post') && $this->request->is('ajax')) {
            $data = $this->request->data;
            $message_owner = $data['Message']['message_sender_id'] ?? null;
