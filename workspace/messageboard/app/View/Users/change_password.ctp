                   ...
                   <div id="changePasswordMessage" class="mt-3 mb-3"></div>
                    <?php echo $this->Form->create('User', ['id' => 'changePasswordForm']); ?>
                        <div class="form-group">
                            ...
                            echo $this->Form->password('current_password', ['class' => 'form-control mb-2', 'required' => true]);
                            ?>
                        </div>
                        <div class="form-group">
                            <?php
                            echo $this->Form->label('new_password', 'New Password:');
                            echo $this->Form->password('new_password', ['class' => 'form-control mb-2', 'required' => true]);
                            ?>
                        </div>
                        <div class="form-group">
                            <?php
