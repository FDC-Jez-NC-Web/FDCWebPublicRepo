<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-success fw-bold text-white text-uppercase">New Message</div>
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <?php
                        echo $this->Form->button('START CONVERSTION', ['type' => 'submit', 'class' => 'btn btn-success mt-2']);
                        echo $this->Form->end();
                        ?>
                        <div class="mt-3">
